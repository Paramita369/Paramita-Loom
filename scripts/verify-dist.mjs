...
const approvedSlugs = [
  ...
  'guides/openclaw/windows-install',
...
const approvedTitleChecks = {
  ...
  'zh-hk/guides/openclaw/windows-install/index.html': {
    expected: [
      '如何在 Windows 安裝 OpenClaw',
      '最短成功路徑',
      'WSL2',
      'Ubuntu',
      'wsl --install',
...
const guideMetadataSourceChecks = {
  ...
  'src/content/docs/zh-hk/guides/openclaw/mac-install.mdx': [
    'guideVersion:',
    'verifiedAt:',
    'nextReviewAt:',
    'stalePolicyCode:',
  ...
  'src/content/docs/zh-hk/guides/openclaw/windows-install.mdx': [
    'guideVersion:',
    'verifiedAt:',
    'nextReviewAt:',
    'stalePolicyCode:',
  ...
  'src/content/docs/zh-hk/index.mdx': [
    ...
    '用 WSL2 + Ubuntu + 官方 CLI 在 Windows 開始 OpenClaw 公開預覽',
  ],
  'src/content/docs/zh-hk/guides/index.mdx': [
    'filterVisibleGuides',
    "nextReviewAt: '2026-04-19'",
    '普通用家用官方 CLI 進入公開預覽',
    'Windows 版現時推薦 `WSL2 + Ubuntu` 路線',
  ],
...
const pageSpecificPhraseChecks = {
  ...
  'zh-hk/guides/openclaw/windows-install/index.html': {
    expected: [
      ...
      '1. 安裝 WSL2 同 Ubuntu',
      '2. 啟用 systemd',
      '3. 在 Ubuntu 裝 OpenClaw CLI',
      '4. 跑首次設定',
      '5. 檢查 gateway、dashboard 同 doctor',
      'href="#error-1"',
      'href="#step-1"',
      'href="#step-5"',
      '可以直接複製錯誤文字，或者截圖目前畫面，然後問 AI 幫你解讀下一步',
      '目前仍未在乾淨原生 Windows 普通用家流程完整重跑',
    ],
    forbidden: [
      '為什麼值得關心',
      '核心模型',
